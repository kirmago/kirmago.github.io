        ...
        {loading ? (
          ...
          <>
            <div className="cek-postingan-container">
              {flattenData(elements).map((element, index) => (
                <div key={index} className="rendered-cek-postingan">
            ...
            <div onClick={() => handleLike(postId)} className="likeds">
              <button><span className="material-symbols-rounded">thumb_up</span></button>
              <p>{!totalLike ? 0 : totalLike }</p>
            </div>
             <div onClick={() => handleUnLike(postId)} className="likeds">
              <button><span className="material-symbols-rounded">thumb_down</span></button>
              <p>{!totalUnlike ? "0" : totalUnlike }</p>
            </div>
            </div>
            </div>
          </>
